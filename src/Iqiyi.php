...
class Iqiyi
{
    ...
    public static function get_tmts_url($ids)
    {//付费视频提交cookie
    ...
    public static function get_tmts2_url($ids)
    {//付费视频提交cookie
        preg_match('#P00010=(\d+);#iU', COOKIE_IQIYI, $_uid);
        preg_match('#QC006=(.*);#iU', COOKIE_IQIYI, $_qyid);
        $domain = "http://cache.m.iqiyi.com";
    ...
    public static function get_app_data($ids)
    {  //app端的vf算法
        preg_match('#P00010=(\d+);#iU', COOKIE_IQIYI, $_uid);
        preg_match('#QC006=(.*);#iU', COOKIE_IQIYI, $_qyid);
    ...
    public static function get_vps_data($ids)
    { //pc 端接口
        preg_match('#P00010=(\d+);#iU', COOKIE_IQIYI, $_uid);
        preg_match('#QC006=(.*);#iU', COOKIE_IQIYI, $_qyid);
